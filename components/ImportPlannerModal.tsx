  ...
  const handleProcessImport = () => {
    try {
      ...
      const newTrip: TripDetails = {
        ...
        pickupTime: '09:30 AM',
        pickupLocation: generated.pickupLocation || 'Kochi Airport (COK)',
        dropoffDate: generated.dropoffDate || '25th Sept 2026',
        dropoffTime: '05:00 PM',
        dropoffLocation: generated.dropoffLocation || 'Kochi / Trivandrum Airport',
        routeSummary: generated.routeSummary || 'Kochi → Munnar → Thekkady → Alleppey → Kovalam → Kanyakumari → Kochi',
